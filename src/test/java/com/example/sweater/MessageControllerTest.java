...
public class MessageControllerTest {
    ...
    public void filterMessageTest() throws Exception {
        this.mockMvc.perform(get("/man").param("filter", "my-tag"))
                .andDo(print())
                .andExpect(authenticated())
    ...
    public void addMessageToListTest() throws Exception{
        MockHttpServletRequestBuilder multipart = multipart("/man")
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//div[@id='message-list']/div/span").string("fifth"))
                .andExpect(xpath("//div[@id='message-list']/div/i").string("#new one"));
    }
}
